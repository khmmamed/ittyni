...
export class ExLogin extends Component{
            ...
            <div className="content">
                ...
                <form className="login-form">
                    ...
                    <div className="create-account">
                        <p>
                            <a className="btn-primary btn" id="register-btn">Create an account</a>
                        </p>
                    </div>
                </form>
            </div>
...
/*
                ...
                <form className="register-form" action="index.html" method="post" novalidate="novalidate" style="display: none;">
                    <div className="form-title">
                    ...
                    <div className="form-actions">
                        ...
                        <button type="submit" id="register-submit-btn" className="btn red uppercase pull-right">Submit</button>
                    </div>
                </form>
*/